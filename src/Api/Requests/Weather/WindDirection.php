 ...
 *
 *
 * **[https://api-open.data.gov.sg/v2/real-time/api/wind-direction](https://api-open.data.gov.sg/v2/real-time/api/wind-direction)**
 *
 * <br/>
 *
 * -
 ...
 */
class WindDirection extends Request
{
