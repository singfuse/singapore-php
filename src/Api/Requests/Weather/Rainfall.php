 ...
 *
 *
 * **[https://api-open.data.gov.sg/v2/real-time/api/rainfall](https://api-open.data.gov.sg/v2/real-time/api/rainfall)**
 *
 * <br/>
 *
 * -
 ...
 * <br/>
 *
 * - Filter for specific date or date-time by providing `date` in
 * query parameter.
 ...
 */
class Rainfall extends Request
{
